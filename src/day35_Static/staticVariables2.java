...
public class staticVariables2 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(staticVariables2.staticVariable); //400 static can be called through the class name
       // System.out.println(staticVariable2.insVariable); // instance CANNOT be called through the class name
