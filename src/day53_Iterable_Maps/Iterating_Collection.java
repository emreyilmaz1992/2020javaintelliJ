...
public class Iterating_Collection {
    ...
    public static void main(String[] args) {
        ...
        list2.removeIf(p->p<4); // using the iterator interface internally
      ...
      //  System.out.println(it);
       ...
       // System.out.println(it.next()); if we use it before the while loop it will skip iterating the first object
