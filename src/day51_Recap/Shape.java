...
public abstract   class Shape {
    ...
    public abstract double calculateArea(); // we can ignore the details by using the abstract
...
interface Volume{
    ...
    boolean hasVolume = true; // by default variable final static, so we gotta assign it right away. interface cannot have method. All method in interface is abstract
    public double calculateVolume(); // this is abstract
