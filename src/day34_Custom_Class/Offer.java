...
create a class called MyOffers
    ...
    public String toString(){
        String salary = ""+this.salary; //converts it to the string so you can manipulate it
        return "Location : "+location+" Salary $"+salary+" Company: "+company+" Full time: "+isFullTime;
    }
